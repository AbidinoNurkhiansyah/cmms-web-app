<x-modal wire:model="addModal" title="Add New User" box-class="w-11/12 max-w-4xl overflow-visible" separator>
    <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div class="md:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <x-choices label="Position" wire:model="addPosition" :options="$positionOptions" placeholder="Select Position" single searchable />
            <x-choices label="Team" wire:model="addTeam" :options="$teamOptions" placeholder="Select Team" single searchable />
            <x-choices label="Unit (Jobdesc)" wire:model="addJobdesc" :options="$unitOptions" placeholder="Select a unit" class="md:col-span-2" single searchable />
        </div>
    </div>
    <x-slot:actions>
